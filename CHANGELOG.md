...
* add error message if controller is used before attached to a mobile scanner widget ([a263c6f](https://github.com/dwikyhardi/mobile_scanner/commit/a263c6f23486a39e0792bd45a9f011d130289dcd))
* add focus point func, initial zoom position and use of ultra wide camera on Ios ([0e02e66](https://github.com/dwikyhardi/mobile_scanner/commit/0e02e66cedfee839c541021993002b7453b8e99f))
* add focus point functionality and initial zoom settings for mobile scanner, along with optional use of ultraWideAngle camera on ios ([fb4f0ea](https://github.com/dwikyhardi/mobile_scanner/commit/fb4f0eaf0e56ebe06b9f5e77c36adf9b36f3585c))
* Add getSupportedLenses() stub and lensType controller parameter ([cc5c42b](https://github.com/dwikyhardi/mobile_scanner/commit/cc5c42b50ee19ceab6259cce553eca102c66392a))
* add iOS barcodeType detection ([004d488](https://github.com/dwikyhardi/mobile_scanner/commit/004d4886c661c78338ae406b0af83bb747b316df))
* add iOS barcodeType detection ([6c61481](https://github.com/dwikyhardi/mobile_scanner/commit/6c61481e7f3ebf4fbf6f172c677632e3035604a2))
* add support for ITF 2 of 5 ([c7f2c12](https://github.com/dwikyhardi/mobile_scanner/commit/c7f2c1239f342c58e35c8eac36b2a79c478f19f1))
* Added lens enum types ([e366955](https://github.com/dwikyhardi/mobile_scanner/commit/e366955221e7b5266935e58e806d47ea08b4c18d))
* Added method names as constants in `mobile_scanner_method_channel.dart` ([c0acf6c](https://github.com/dwikyhardi/mobile_scanner/commit/c0acf6cb6d1a73b07a94dcee7ba38a87340aee54))
* Android implementation for querying camera lenses ([29a1e3a](https://github.com/dwikyhardi/mobile_scanner/commit/29a1e3a419e7963577644dcf25e67a7c24fa5215))
* **android:** use OrientationEventListener for orientation ([b10087c](https://github.com/dwikyhardi/mobile_scanner/commit/b10087c8f2f9e3eba46e08431d8e6ba14f435a5d))
* Apple implementation for querying camera lenses ([b61cbe3](https://github.com/dwikyhardi/mobile_scanner/commit/b61cbe343058be37656887124254936dd4bf0127))
* Flutter view barcode corners ([f666714](https://github.com/dwikyhardi/mobile_scanner/commit/f6667149bc2379219b1d2efd569bb0df66de5167))
* Implement example for lens switching ([c3a6c93](https://github.com/dwikyhardi/mobile_scanner/commit/c3a6c9335e8ebcee1c4f17e6e6c9e5a935a861c7))
* Implemented lens selection on web ([d999dc0](https://github.com/dwikyhardi/mobile_scanner/commit/d999dc05e3fe3d92aaaf0b39e27daf0cb4783ac0))
* release of v7.0.0 ([3c5a9ac](https://github.com/dwikyhardi/mobile_scanner/commit/3c5a9ac34200436a1ff18611f20847e70f721abc))
* tap to focus, initial zoom and more lenses ([0ae802a](https://github.com/dwikyhardi/mobile_scanner/commit/0ae802a0e3fb8406dca8dd31863ec53b859c3128))
* update screenshots to represent the latest example app ([a09039a](https://github.com/dwikyhardi/mobile_scanner/commit/a09039a591c22b78427f8325a6d14cef8ea6ae25))


### Bug Fixes

* [Android] reset isPaused flag in start() called ([cc66756](https://github.com/dwikyhardi/mobile_scanner/commit/cc66756cad7a35d1b7c6679c58edaa4083392d55))
* [Android] reset isPaused flag on start() called ([721f225](https://github.com/dwikyhardi/mobile_scanner/commit/721f2253b9400bbf92018a0ba3f03f8c083c5131))
* add barcode payload parser ([343fac0](https://github.com/dwikyhardi/mobile_scanner/commit/343fac0a167be3028d344c1d42429e6850f53bb2))
* add exclusion for macos ([b86610f](https://github.com/dwikyhardi/mobile_scanner/commit/b86610f0a4cf1b4e4fcc69d746b613abeaf2c254))
* add exclusion for macos ([2a54ea6](https://github.com/dwikyhardi/mobile_scanner/commit/2a54ea67dcfe1fcc647acffaf3ff88d2ecec1124))
* add ignore pointer to other widgets in stack to fix tapToFocus ([1f33cdf](https://github.com/dwikyhardi/mobile_scanner/commit/1f33cdf9c02d8f73e8693391c929d3205c23141f))
* add isStarting to state in order to track if initialization is currently in progress ([a761e45](https://github.com/dwikyhardi/mobile_scanner/commit/a761e45a6a8bf1f1e7434c661970ccd187d4844b))
* add isStarting to state in order to track if initialization is currently in progress ([8344d5d](https://github.com/dwikyhardi/mobile_scanner/commit/8344d5d166e57fa11ac042ad455f8c2ab04776fa))
* add missing deviceOrientation parameter to BarcodePainter tests ([ebb3b4d](https://github.com/dwikyhardi/mobile_scanner/commit/ebb3b4d6497d64a4d9562a8307794d7778cda209))
* add toString for jvmTarget ([a3d68dc](https://github.com/dwikyhardi/mobile_scanner/commit/a3d68dc0e57ea8eb6e8dccb385e232c32a050f7e))
* add upperbound for meta dependency ([715c50f](https://github.com/dwikyhardi/mobile_scanner/commit/715c50f2ebaefd57bda24edcfa388e35c6481899))
* all device orientations on ios ([60ba123](https://github.com/dwikyhardi/mobile_scanner/commit/60ba12364ff61aaeec6c188a180fc95ec58c7c97))
* apply latest lint changes ([910604d](https://github.com/dwikyhardi/mobile_scanner/commit/910604dd8e5cbd0725aae7c6e0f309d25f2b8977))
* apply latest lint changes for example app ([2be82c3](https://github.com/dwikyhardi/mobile_scanner/commit/2be82c312ef657208d6658057aff2b119bb25daf))
* arrow to block notation ([689d7b4](https://github.com/dwikyhardi/mobile_scanner/commit/689d7b4227a34992f42449c1aa70e7a37fa07534))
* Assign event channel streams to null on stop() ([1a5fc53](https://github.com/dwikyhardi/mobile_scanner/commit/1a5fc53ac3c38055d130cd8871c8aedbf31f8aa8))
* await setFocusPoint ([1eac3ac](https://github.com/dwikyhardi/mobile_scanner/commit/1eac3acb041bcdad2eda5d457b396f4d79617850))
* barcode corners for web overlay ([0147320](https://github.com/dwikyhardi/mobile_scanner/commit/0147320797f6131a55c0ec482836e3312df2c1f7))
* black screen after multiple initialization ([18c05e6](https://github.com/dwikyhardi/mobile_scanner/commit/18c05e67f70c84e68718b18f6e139caf6df28dbd))
* build for macos ([068c73b](https://github.com/dwikyhardi/mobile_scanner/commit/068c73bde325ad03aa65a2eba9e9f1b2e50cc8ec))
* camera orientation on macos, reinitialization of controller in example, ([5ba0009](https://github.com/dwikyhardi/mobile_scanner/commit/5ba0009f70ace68a4ddf0a875d01e375ee135735))
* camera view placeholder for test ([da730d4](https://github.com/dwikyhardi/mobile_scanner/commit/da730d4f6f06e3103ebb8d60396d7146ef6c3ef9))
* change dispose check to same as init check ([7861d90](https://github.com/dwikyhardi/mobile_scanner/commit/7861d906e2a1f13abbd1a6e157cdfcb07c97c655))
* change old surface producer API usage ([f55617d](https://github.com/dwikyhardi/mobile_scanner/commit/f55617df866d5da66ff22c5ada208c7c5f0e05ab))
* change screenshot order ([6c5c5b0](https://github.com/dwikyhardi/mobile_scanner/commit/6c5c5b068815f6e581725004633f097b52faa098))
* check for same rotation on older code path ([cb7c361](https://github.com/dwikyhardi/mobile_scanner/commit/cb7c36100c40bd904568601288c064adfdb33c21))
* cleanup changelog ([e74c984](https://github.com/dwikyhardi/mobile_scanner/commit/e74c984c702236e72792dc9e78726cc32ce1e81c))
* core style ([6cd552a](https://github.com/dwikyhardi/mobile_scanner/commit/6cd552a20c77ca9b6d789cda24290d47898dca15))
* correct texture size on orientation change ([4a60da0](https://github.com/dwikyhardi/mobile_scanner/commit/4a60da0088e83ea359e2a3691160ccc393542641))
* dependency update ([e0f9f5a](https://github.com/dwikyhardi/mobile_scanner/commit/e0f9f5a7dd7f056395edb340091060465297c75b))
* device orientation checked on older and newest sdk ([aafc07a](https://github.com/dwikyhardi/mobile_scanner/commit/aafc07aa977c8f878954cd5f76d3f983828455bf))
* device orientation checked on older and newest sdk ([4b0e7a2](https://github.com/dwikyhardi/mobile_scanner/commit/4b0e7a211a5d4c1e708b158c30d9c379fab74749))
* Device orientation handling not respecting auto-rotate settings (Android) ([2e45fc8](https://github.com/dwikyhardi/mobile_scanner/commit/2e45fc89f19a77f34fa8f703f84e08c107c9d5ff))
* device orientation lock on android by listening to display orientation rather than device sensor orientation ([af2541a](https://github.com/dwikyhardi/mobile_scanner/commit/af2541abf91c9a31dd033aac364f752257917592))
* doc ([4eadb43](https://github.com/dwikyhardi/mobile_scanner/commit/4eadb43f04c71f96e8230127f4f3fff177e40771))
* don't rotate when device orientation has been locked from flutter side ([ceea083](https://github.com/dwikyhardi/mobile_scanner/commit/ceea0830a15088f6329541fad5d2559fcab9486b))
* filter out null values ([8254a8d](https://github.com/dwikyhardi/mobile_scanner/commit/8254a8d369d4c4634a56685b136815da7e7b1ffd))
* fix on detect not working when controller is provided ([58f2df7](https://github.com/dwikyhardi/mobile_scanner/commit/58f2df7398512cf20d15ab7e43b778f8604dd0e8))
* format according to dart 3.7 ([74a686d](https://github.com/dwikyhardi/mobile_scanner/commit/74a686d2c3b01610df36f2c3bfa4e2879bd64d23))
* groovy syntax ([4bd2a94](https://github.com/dwikyhardi/mobile_scanner/commit/4bd2a9406b4a0321460807dc99af3b8e3dd68811))
* handle errors from cvcreatepixelbuffer ([3d8565f](https://github.com/dwikyhardi/mobile_scanner/commit/3d8565fe7310678cd23ce0f7f286942572302b82))
* hot reload ([460a6d8](https://github.com/dwikyhardi/mobile_scanner/commit/460a6d8cd7380c962cc29ca05e7d6a62ef514278))
* hot-restart by adding force parameter ([f5cfe45](https://github.com/dwikyhardi/mobile_scanner/commit/f5cfe4553eb74cfa60d5565b1b75a386889a4c16))
* improve attached code handling for end users ([061a2fc](https://github.com/dwikyhardi/mobile_scanner/commit/061a2fc1faa04f4f46fea1f9dcc13aa16db806ca))
* improve pixel format selection for video output on iPhone 17 ([82f8b25](https://github.com/dwikyhardi/mobile_scanner/commit/82f8b25b346bb83fb04daac54d4d73de3d5d1f23))
* improve pixel format selection for video output on iPhone 17 ([51055a5](https://github.com/dwikyhardi/mobile_scanner/commit/51055a52365ddcefd4b34acb6d5fca030bc7c1b8))
* improve pixel format selection for video output on iPhone 17 ([3dc0823](https://github.com/dwikyhardi/mobile_scanner/commit/3dc08239692ae702abbc7364abbe75c5ee156259))
* increase minSdkVersion from 21 to 23 ([9667f6d](https://github.com/dwikyhardi/mobile_scanner/commit/9667f6df70190996292d59933960a958e3b6a362))
* ios overlay orientation ([5f8636c](https://github.com/dwikyhardi/mobile_scanner/commit/5f8636c0da9e2b6f673de3ed1b0fe94511b321af))
* **ios:** use device orientation for video orientation ([4a3008a](https://github.com/dwikyhardi/mobile_scanner/commit/4a3008aec729c4c208c524df897e62236e7a3595))
* kotlin error during build ([4487371](https://github.com/dwikyhardi/mobile_scanner/commit/44873713b00fc4e4a06b1f56c2500985556fc135))
* latest linter style by very_good_analysis ([54b983d](https://github.com/dwikyhardi/mobile_scanner/commit/54b983defa18b9cba126cf6643f406c0e4e25398))
* **lint:** wrap long lines in barcode_painter.dart to comply with 80-char limit ([1bbfcd4](https://github.com/dwikyhardi/mobile_scanner/commit/1bbfcd455626a28d2f1831297fc72cb30c4f4eba))
* macos overlay text ([1fa5863](https://github.com/dwikyhardi/mobile_scanner/commit/1fa586344ad789426c6425dca92824656c5bbf47))
* **macos:** wrap deprecated devices(for:) in #if os(iOS) ([2c51a37](https://github.com/dwikyhardi/mobile_scanner/commit/2c51a3709e84c126088250a05f7a04006bb083fa))
* **macos:** wrap deprecated devices(for:) in #if os(iOS) ([bd4d4a7](https://github.com/dwikyhardi/mobile_scanner/commit/bd4d4a7f2979bea0272a7d8d82b1630380987396)), closes [#1558](https://github.com/dwikyhardi/mobile_scanner/issues/1558)
* make async initialization and dispose calls in separate async function ([5276188](https://github.com/dwikyhardi/mobile_scanner/commit/5276188ef8736a55bf8fd0157d57a7886147f0d0))
* merge conflict ([1cb6979](https://github.com/dwikyhardi/mobile_scanner/commit/1cb69791a1bbcb9f9698803c007f574eb157864a))
* merge conflicts ([7b5b2bc](https://github.com/dwikyhardi/mobile_scanner/commit/7b5b2bc9607090de150128d82fb460ca999e5876))
* merge issues ([f856972](https://github.com/dwikyhardi/mobile_scanner/commit/f856972d018e86a716122ad31fa40541c437c779))
* merge orientation listeners into one ([9f42e26](https://github.com/dwikyhardi/mobile_scanner/commit/9f42e26a4d5191ca40f8a11451e2323e6b786b49))
* migrate deprecated assignment to new syntax ([2339c7c](https://github.com/dwikyhardi/mobile_scanner/commit/2339c7cbfef9f2e4afbe365c21c52d577a5879d8))
* migrate rawBytes to byte array from payloadStringValue. ([b859b99](https://github.com/dwikyhardi/mobile_scanner/commit/b859b9948ce1870d5097ff89e0fea29096936358))
* migrate rawBytes to byte array from payloadStringValue. migrate payloadData to rawPayloadData ([efefbf6](https://github.com/dwikyhardi/mobile_scanner/commit/efefbf683fad76e750e8d022544d29b835456867))
* migrate to new nv21 output, remove deprecated renderscript api ([715717f](https://github.com/dwikyhardi/mobile_scanner/commit/715717f553e6835abd81bae8a6989d8270f1ac40))
* move subscription.cancel to async dispose, move removeObserver ([7f45793](https://github.com/dwikyhardi/mobile_scanner/commit/7f457936e6232257f5c50e6abdcd6af8ad420c7d))
* move widget test to example app, where widget resides ([3e8c842](https://github.com/dwikyhardi/mobile_scanner/commit/3e8c842f6f533377181064935f4d1ad6ca072785))
* not attached error message ([5d71d4b](https://github.com/dwikyhardi/mobile_scanner/commit/5d71d4bf61ff8a8fc94a1df87a58afb36d0fd576))
* not attached error message ([5fc60b0](https://github.com/dwikyhardi/mobile_scanner/commit/5fc60b09ddd39379669a07dfc0e59aa9835ce62a))
* nv21 update ([250bea4](https://github.com/dwikyhardi/mobile_scanner/commit/250bea49fb42a36ba273047579274eb6b0629ca3))
* optional value ([3af169d](https://github.com/dwikyhardi/mobile_scanner/commit/3af169d24583847d634b92b5a98de996e34ebdf9))
* optional value ([079726f](https://github.com/dwikyhardi/mobile_scanner/commit/079726f451448573d00d7165b3532c6be839fb6a))
* **orientation:** refactor orientation detection and fix related issues ([61b2f8a](https://github.com/dwikyhardi/mobile_scanner/commit/61b2f8ac3a63edef6d72bc178e2ee55063940945))
* overlay position on landscape ([a9752bc](https://github.com/dwikyhardi/mobile_scanner/commit/a9752bc29934b1a72476b3f612dc68abd9063a5b))
* **overlay:** correct barcode overlay alignment on orientation change ([6ca108d](https://github.com/dwikyhardi/mobile_scanner/commit/6ca108d1ba407a6f02d2e8dc85455455cefd848a))
* position of variable ([7459d69](https://github.com/dwikyhardi/mobile_scanner/commit/7459d69dfbd87983c5b7a4596baa542430d714cd))
* prevent half-stopped camera state causing false ALREADY_STARTED_ERROR. ([ebfe58d](https://github.com/dwikyhardi/mobile_scanner/commit/ebfe58d4d2a6eaa9740b151681ba2e4a6b919d05))
* prevent half-stopped camera state causing false ALREADY_STARTED. ([7ef6118](https://github.com/dwikyhardi/mobile_scanner/commit/7ef61181672b755ebb90f8f2c0ef23f51e29fd49))
* reinstate dependabot, ([404cda2](https://github.com/dwikyhardi/mobile_scanner/commit/404cda2b914cfca16d4864a0a61f6ff437d091e0))
* remove depreacted package assignment ([c9efc60](https://github.com/dwikyhardi/mobile_scanner/commit/c9efc6073b64a3cc6e55900929501c414f8d6fb9))
* remove old code ([e0381d7](https://github.com/dwikyhardi/mobile_scanner/commit/e0381d7a6b98edbc79c0815294262e80ac645d04))
* remove overlay on orientation change due to wrong position ([c3aa13d](https://github.com/dwikyhardi/mobile_scanner/commit/c3aa13db07b28e7d3064625f930a54f61dc6ad74))
* remove print ([2b45cb2](https://github.com/dwikyhardi/mobile_scanner/commit/2b45cb2b79212e48503b9b2f3f4e72d44de5a2b9))
* remove redundant initializer ([1a8ed1c](https://github.com/dwikyhardi/mobile_scanner/commit/1a8ed1c00e593f301363b9f7b6bc10164421814c))
* remove redundant null checks, upgrade macos files for latest flutter ([0c5283d](https://github.com/dwikyhardi/mobile_scanner/commit/0c5283d3d634362dbacddb632c2a3f3a3792b6f8))
* remove team ([1c3a21e](https://github.com/dwikyhardi/mobile_scanner/commit/1c3a21e90e07666a7e9f9c95262b65eccb8cdc13))
* remove unnecessary stream pause on inactive, only use observer when no controller is passed ([594b583](https://github.com/dwikyhardi/mobile_scanner/commit/594b58379feaedde96bc845139427a3b7969581c))
* replace deprecated Radio API with RadioGroup ([0bd6d6f](https://github.com/dwikyhardi/mobile_scanner/commit/0bd6d6f4de0ce59c314962870d33b69469bb77da))
* replace deprecated Radio API with RadioGroup ([4809505](https://github.com/dwikyhardi/mobile_scanner/commit/480950517c1574bbeb9566bbc2994b32a5464c21))
* replaced dead analysisBuilder with correct target rotation ([e20e475](https://github.com/dwikyhardi/mobile_scanner/commit/e20e4751660b988c12af780f2326e260ed6d7165))
* replaced dead analysisBuilder with correct target rotation ([9311b85](https://github.com/dwikyhardi/mobile_scanner/commit/9311b853995d75da8e0891a6ec6e3257385a5618))
* revert kotlin library for compatibility ([a158e95](https://github.com/dwikyhardi/mobile_scanner/commit/a158e95459493dc388e35de902c09eea1bf27779))
* revert safe return ([e44b335](https://github.com/dwikyhardi/mobile_scanner/commit/e44b335388a000c3a3d0a7e6dc96da93ac304f7c))
* revert the required initial zoom ([e1ad348](https://github.com/dwikyhardi/mobile_scanner/commit/e1ad348a4d1324d475c11804bf1e4cb19126a5fb))
* rotation when no restriction is set ([a6c7af1](https://github.com/dwikyhardi/mobile_scanner/commit/a6c7af16deb168b88ae4a03726ab6470a7e58253))
* rotation while locked for android ([06c0dbf](https://github.com/dwikyhardi/mobile_scanner/commit/06c0dbf74be65b36c35c30449db43e636fd58d26))
* rotation while locked for apple ([3b62d9f](https://github.com/dwikyhardi/mobile_scanner/commit/3b62d9f135ee477a91aede910d35032ddd6fa195))
* set _isAttached to false on dispose ([0a1007c](https://github.com/dwikyhardi/mobile_scanner/commit/0a1007c32bc08b63021967b94732ab6f0a300d41))
* set best camera quality on darwin ([56f3a2b](https://github.com/dwikyhardi/mobile_scanner/commit/56f3a2b965221a9fa97fd60be97390c365a9a9ff))
* set to null at stop ([7991bbe](https://github.com/dwikyhardi/mobile_scanner/commit/7991bbe660ed646bc098a2dca97b62bf5194a81f))
* skip deprecated enum ([2f3d8ca](https://github.com/dwikyhardi/mobile_scanner/commit/2f3d8ca8e3f743e41b31681bed0a9782f16cdce5))
* specify platforms ([0169e0e](https://github.com/dwikyhardi/mobile_scanner/commit/0169e0e5986bdd1ed9ba5ebc269ec2ecf2ff5501))
* state never initialized when controller is already running ([854a15d](https://github.com/dwikyhardi/mobile_scanner/commit/854a15d72eb1befa94160c85f947e44b761b3393))
* test correctness ([ae6af50](https://github.com/dwikyhardi/mobile_scanner/commit/ae6af508ce1775a1eb348277e24e41b756b9e3e1))
* text overlay being upside down ([66339ed](https://github.com/dwikyhardi/mobile_scanner/commit/66339edc06a4a04787d807416e439e5aea501ac4))
* update corner processing of BarcodeCorners for web ([df49a05](https://github.com/dwikyhardi/mobile_scanner/commit/df49a05943c8b9e63cd4669edb755dc2f9580436))
* update gradle JVM args ([b3d33e3](https://github.com/dwikyhardi/mobile_scanner/commit/b3d33e3bb0784b1bbf676c0cbd08a950612376de))
